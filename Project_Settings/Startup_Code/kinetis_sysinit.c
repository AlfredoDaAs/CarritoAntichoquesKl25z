...
void TPM0_IRQHandler() __attribute__ ((weak, alias("Default_Handler")));//void FTM0_IRQHandler() __attribute__ ((weak, alias("Default_Handler")));
...
void (* const InterruptVector[])() __attribute__ ((section(".vectortable"))) = {
    ...
    TPM0_IRQHandler,//FTM0_IRQHandler, /* FTM0 fault, overflow and channels interrupt */
